                        ...
                        <div class="col mr-2">
                            ...
                            <div class="mt-2">
                                <small class="text-info me-2">
                                    <i class="fas fa-arrow-right"></i> 5.4%
                                </small>
                                <small class="text-muted">vs last month</small>
                            </div>
                        </div>
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                            ...
                            <a class="dropdown-item" href="#">{{ __('Export') }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="activity-item">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <strong>{{ __('New employee registered') }}</strong>
                                <p class="text-muted mb-0">John Doe joined the company</p>
                            </div>
                    ...
                    <div class="activity-item">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <strong>{{ __('Leave request approved') }}</strong>
                                <p class="text-muted mb-0">Jane Smith's vacation request approved</p>
                            </div>
                    ...
                    <div class="activity-item">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <strong>{{ __('Stage updated') }}</strong>
                                <p class="text-muted mb-0">Development stage configuration changed</p>
                            </div>
