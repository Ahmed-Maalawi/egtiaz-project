<x-dashboard.main-layout>
    ...
    <div class="card-body">
        <form class="my-3" action="{{ route('admins.types.update', $type->id) }}" method="post"
            ...
            <div class="form-group">
                ...
                <input type="text" name="name_ar" class="form-control" id="name" placeholder="{{ __('Name') }}"
                    required value="{{ old('name_ar') ?? $type->getTranslation('name', 'ar') }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="name_en" class="form-control" id="name"
                    ...
                    value="{{ old('name_en') ?? $type->getTranslation('name', 'en') }}">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description_ar" class="form-control" id="description_ar" placeholder="{{ __('Description in Arabic') }}"
                    required>{{ old('description_ar') ?? $type->getTranslation('description', 'ar') }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description_en" class="form-control" id="description_en"
                    placeholder="{{ __('Description in English') }}" required>{{ old('description_en') ?? $type->getTranslation('description', 'en') }}</textarea>
            </div>
