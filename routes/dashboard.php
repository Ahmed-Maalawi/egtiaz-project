...
Route::group([
    ...
    Route::group([
        ...
        Route::delete('unpay-employee-stage/{employeeStage}', [EmployeeStageController::class, 'destroy'])->name('unpay');
    });
    ...
    Route::group(['prefix' => 'hr'], function () {
        ...
        Route::delete('/salaries/{salary}', [SalariesController::class, 'destroy'])->name('hr.salaries.delete');
